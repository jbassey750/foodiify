...
const objItems = new Array(
  {
    ...
    category: "food",
    image:
      "../image/Best-Birthday-Cake-with-milk-chocolate-buttercream-SQUARE.webp",
  },
  {
    name: "Ice cream",
    id: 2,
  ...
  for (const [index, div] of divs.entries()) {
    div.addEventListener("click", () => {
      ...
      document.querySelector(
        ".counter"
      ).style.cssText = `background-color: #fbc606;
            color: #fdfdfd;
            border-radius: 4px;
            padding: 2px 2px
            `;
